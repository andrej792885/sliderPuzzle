...
(function(){
    ...
    p.init = function () {
        ...
        const sliderProgressionTxt = this._sliderProgressionTxt = system.CustomMethods.makeText("" , "27px Russo One" , "white" , "center" , "alphabetic");
        sliderProgressionTxt.x = playBtn.x;
        sliderProgressionTxt.y = 950;
...
/*        this.fps = system.CustomMethods.makeText("","27px Russo One" , "white" , "center" , "alphabetic");
    ...
    p.updateLocalStorage = function() {
        const stats = {
            "sliderPuzzleSolvedLevels": this.player.sliderPuzzleSolvedLevels,
